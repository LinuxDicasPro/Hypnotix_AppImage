...
APP=hypnotix
BIN="$APP"
DEPENDENCES="python circle-flags dconf hicolor-icon-theme mpv python-cairo python-gobject python-cinemagoer python-requests python-setproctitle python-unidecode xapp libgirepository gtk3 gobject-introspection-runtime pango harfbuzz gdk-pixbuf2 at-spi2-core glib2 glibc binutils mujs python-idna librsvg libvdpau-va-gl mesa hicolor-icon-theme shared-mime-info adwaita-icon-theme"
BASICSTUFF="debugedit gzip"
...
BINSAVED="SAVEBINSPLEASE mkdir touch"
...
mv ./Hypnotix-x86_64.AppImage ./Hypnotix-"$VERSION"-x86_64.AppImage
